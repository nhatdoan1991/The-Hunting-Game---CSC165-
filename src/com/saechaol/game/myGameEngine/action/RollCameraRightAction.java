...
/**
 * An action handler that rolls the camera right. Rotation is calculated using Quaternions.
 * @author Lucas
 *
 */

public class RollCameraRightAction extends AbstractInputAction {

	private MyGame game;
	
	public RollCameraRightAction(MyGame g) {
		game = g;
	}
	
	@Override
	public void performAction(float time, Event e) {
	//	System.out.println("Rolling camera right");
		Angle rotationSpeed;
		if (game.invertYaw) {
